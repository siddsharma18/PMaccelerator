...
# Load model and encoders using absolute relative paths
BASE_DIR = os.path.dirname(os.path.abspath(__file__))

model = joblib.load(os.path.join(BASE_DIR, "..", "weather_mood_model_v3.pkl"))
weather_main_encoder = joblib.load(os.path.join(BASE_DIR, "..", "weather_main_encoder.pkl"))
mood_encoder = joblib.load(os.path.join(BASE_DIR, "..", "weather_mood_encoder.pkl"))
